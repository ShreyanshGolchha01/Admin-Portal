...
const HealthRecords: React.FC = () => {
  ...
  const [healthRecords, setHealthRecords] = useState<HealthRecord[]>([
    {
      ...
      symptoms: ['खांसी', 'हल्का बुखार'],
      diagnosis: 'सामान्य सर्दी-जुकाम',
      medications: ['पैरासिटामोल 500mg', 'खांसी की दवा'],
      nextVisit: '2025-07-22',
      status: 'stable',
      doctorNotes: 'मरीज़ की स्थिति सामान्य है। पर्याप्त आराम और तरल पदार्थ लेने की सलाह दी गई।',
    ...
    },
    {
      ...
      diagnosis: 'उच्च रक्तचाप (हाइपरटेंशन)',
      medications: ['एम्लोडिपाइन 5mg', 'लो सॉल्ट डाइट'],
      nextVisit: '2025-07-28',
      status: 'needs-attention',
      doctorNotes: 'रक्तचाप नियंत्रण के लिए नियमित दवा और जीवनशैली में बदलाव आवश्यक।',
      followUpRequired: true
    },
    {
      id: 'HR003',
      ...
      symptoms: [],
      diagnosis: 'मधुमेह नियंत्रण में',
      medications: ['मेटफॉर्मिन 500mg', 'ग्लिमेपिराइड 2mg'],
      nextVisit: '2025-08-13',
      status: 'healthy',
      doctorNotes: 'मधुमेह अच्छे नियंत्रण में है। वर्तमान उपचार जारी रखें।',
      followUpRequired: false
    },
    {
      id: 'HR004',
      patientName: 'प्रिया गुप्ता',
      patientId: 'P004',
      age: 29,
      gender: 'female',
      phone: '9876543213',
      ...
      symptoms: ['तेज़ बुखार', 'उल्टी', 'पेट दर्द'],
      diagnosis: 'वायरल गैस्ट्रोएंटेराइटिस',
      medications: ['ओआरएस', 'एंटी-इमेटिक', 'पैरासिटामोल'],
      nextVisit: '2025-07-19',
      status: 'critical',
      doctorNotes: 'तत्काल चिकित्सा देखभाल की आवश्यकता। तरल पदार्थ की कमी को पूरा करना प्राथमिकता।',
      followUpRequired: true
    }
  ]);
  ...
  const fetchPatientDetails = (patientId: string) => {
    // Mock patients data from PatientsManagement

...
const DoctorProfile: React.FC = () => {
  ...
  const [doctorData, setDoctorData] = useState<DoctorProfileData>({
    personalInfo: {
      name: 'डॉ. राजेश वर्मा',
      email: 'dr.rajesh.verma@health.cg.gov.in',
      phone: '9876543210',
      address: 'सेक्टर 1, न्यू रायपुर, छत्तीसगढ़ - 492002',
    ...
    professionalInfo: {
      ...
      qualification: 'MBBS, MD (सामान्य चिकित्सा)',
      experience: '12 वर्ष',
      currentHospital: 'छत्तीसगढ़ स्वास्थ्य विभाग',
      department: 'सामुदायिक स्वास्थ्य केंद्र',
      joiningDate: '2012-06-01',
      languages: ['हिंदी', 'अंग्रेजी', 'छत्तीसगढ़ी']
    },
    statistics: {
      totalPatients: 2847,
      familiesServed: 673,
  ...
  const achievements = [
    {
      title: 'सर्वोत्तम डॉक्टर पुरस्कार 2023',
      organization: 'छत्तीसगढ़ स्वास्थ्य विभाग',
      date: '2023-08-15',
      icon: Award
    },
    {
      title: 'सामुदायिक सेवा सम्मान',
      organization: 'राष्ट्रीय स्वास्थ्य मिशन',
      date: '2022-12-01',
      icon: Star
    },
    {
      title: 'स्वास्थ्य शिविर उत्कृष्टता',
      organization: 'जिला प्रशासन रायपुर',
      date: '2021-10-02',
      icon: Heart
    }
  ];
  ...
  const recentActivities = [
    {
      date: '2025-07-16',
      activity: 'दुर्ग में स्वास्थ्य शिविर का आयोजन',
      patients: 78,
      type: 'camp'
    },
    {
      date: '2025-07-15',
      activity: 'सामुदायिक स्वास्थ्य जांच',
      patients: 45,
      type: 'checkup'
    },
    {
      date: '2025-07-14',
      activity: 'पारिवारिक स्वास्थ्य परामर्श',
      patients: 23,
      type: 'consultation'
    }
  ];
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">
                      {doctorData.personalInfo.gender === 'male' ? 'पुरुष' : 'महिला'}
                    </p>
                  )}
                </div>

...
const DoctorActivities: React.FC = () => {
  ...
  // Mock comprehensive activities data
  const allActivities: ActivityItem[] = [
    {
      ...
      time: '10:30 AM',
      date: '2025-07-16',
      details: 'बी.पी. 130/80, मधुमेह टेस्ट सामान्य, वजन 72 किग्रा',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'medium'
    },
    {
      ...
      time: '11:15 AM',
      date: '2025-07-16',
      details: 'पारिवारिक स्वास्थ्य कार्ड बनाया, 4 सदस्यों का विवरण दर्ज',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'high'
    },
    {
      ...
      time: '12:00 PM',
      date: '2025-07-16',
      details: 'हाई बी.पी. की दवाई की प्रभावशीलता जांची, सुधार दिखा',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'medium'
    },
    {
      ...
      time: '2:30 PM',
      date: '2025-07-16',
      details: '3 सदस्यों की स्वास्थ्य जांच - माता, पिता और बच्चा',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'high'
    },
    {
      ...
      type: 'prescription',
      patient: 'कमला बाई',
      action: 'दवाई निर्धारण',
      time: '3:15 PM',
      date: '2025-07-16',
      details: 'डायबिटीज के लिए मेटफॉर्मिन 500mg, 15 दिन का कोर्स',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'high'
    },
    {
      ...
      type: 'camp',
      patient: 'शिविर टीम',
      action: 'नया शिविर निर्धारित',
      time: '4:00 PM',
      date: '2025-07-15',
      details: 'बिलासपुर प्राथमिक स्कूल में शिविर - 20 जुलाई',
      status: 'scheduled',
      priority: 'medium'
    },
    {
      ...
      type: 'record',
      patient: 'अनिल शर्मा',
      action: 'मेडिकल रिकॉर्ड अपडेट',
      time: '9:45 AM',
      date: '2025-07-15',
      details: 'पिछली रिपोर्ट अपडेट की गई, एक्स-रे रिपोर्ट जोड़ी',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'low'
    },
    {
      ...
      type: 'checkup',
      patient: 'गीता देवी',
      action: 'प्रसवपूर्व जांच',
      time: '10:20 AM',
      date: '2025-07-15',
      details: '6 महीने की गर्भावस्था, सभी रिपोर्ट सामान्य',
      camp: 'दुर्ग सामुदायिक केंद्र',
      status: 'completed',
      priority: 'high'
    },
    {
      ...
      type: 'followup',
      patient: 'राजू यादव',
      action: 'फॉलो-अप अपॉइंटमेंट',
      time: '2:00 PM',
      date: '2025-07-17',
      details: 'हृदय की जांच के लिए अगली मुलाकात निर्धारित',
      status: 'scheduled',
      priority: 'high'
    },
    {
      id: '10',
      type: 'registration',
      patient: 'लक्ष्मी प्रसाद परिवार',
      action: 'परिवार पंजीकरण',
      time: '11:30 AM',
      date: '2025-07-14',
      details: '5 सदस्यों का पूरा परिवार पंजीकृत किया',
      camp: 'रायपुर सामुदायिक हॉल',
      status: 'completed',
      priority: 'medium'
    }
  ];
